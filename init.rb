...
Redmine::Plugin.register :mega_calendar do
  ...
  version '1.7.3'
  url 'https://github.com/isma-data/mega_calendar'
  author_url 'https://github.com/isma-data'
  requires_redmine :version_or_higher => '4.0.0'
  menu(:top_menu, :calendar, { :controller => 'calendar', :action => 'index' }, :caption => :calendar, :if => Proc.new {(!Setting.plugin_mega_calendar['allowed_users'].blank?)})
